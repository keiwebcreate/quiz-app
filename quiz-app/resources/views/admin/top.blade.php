    ...
    <div class="container px-5 py-6 mx-auto">
        ...
        <div class="flex flex-wrap -m-2">
            <div class="p-2 w-full">
                <button onClick="location.href='{{ route('admin.categories.create') }}'" class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">カテゴリー新規登録</button>
            </div>
        ...
        <tbody>
          @foreach($categories as $category)
            <tr>
                ...
                <td class="px-4 py-3 text-lg text-gray-900"><button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">詳細</button></td>

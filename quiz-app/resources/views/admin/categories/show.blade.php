    ...
    {{-- <section class="text-gray-600 body-font relative mt-5">
        <div class="container px-5 py-6 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">カテゴリー詳細</h1>
            </div>
        </div>
    </section> --}}
        ...
        <tbody>
          {{-- @foreach($categories as $category) --}}
            <tr>
                ...
                <td class="px-4 py-3">問題文です</td>
                <td class="px-4 py-3">2025-10-10 10:00:00</td>
                <td class="px-4 py-3 text-lg text-gray-900"><button  class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">編集</button></td>
